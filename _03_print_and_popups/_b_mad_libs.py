...
if __name__ == '__main__':
    ...
    liquid = simpledialog.askstring(title='Greeter', prompt="name a liquid?")
    # Get the player to enter a body part
    bd = simpledialog.askstring(title='Greeter', prompt="Enter a body part")
    # Get the player to enter a verb
    verb =simpledialog.askstring(title='Greeter', prompt="Enter a verb")
    # Get the player to enter a place
    place = simpledialog.askstring(title='Greeter', prompt="get  a place")
    ...
    "likely take a bite out of your " + bd + " if you " + verb + " . Whatever\n"
    ...
    messagebox.showinfo(None, message=story)
